...
import { Box, TextField, Grid, RadioGroup, FormControlLabel , Radio } from '@mui/material';
import '../css/form.css';
...
<TextField value={formData.password}  label="password" type="password" name="password"  sx={{margin : '10px 0'}}
    ...
    <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="row-radio-buttons-group">
        <FormControlLabel value="female" control={<Radio />} label="Female" name='gender' onChange={handelChange} />
        <FormControlLabel value="male" control={<Radio />} label="Male" name='gender'  onChange={handelChange}/>
